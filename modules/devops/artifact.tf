...
locals {
  region_key = [for s in data.oci_identity_region_subscriptions.oci_region_subscriptions.region_subscriptions : s.region_name if s.region_name == var.region][0].region_key
